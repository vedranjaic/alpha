...
<?php 
// Prevent direct loading of comments.php
...
<div class="comments-area" id="comments">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php printf( _nx( 'One comment', '%1s comments', get_comments_number(), 'Comment title', 'alpha' ), number_format_i18n( get_comments_number() ) ); ?>
		</h2>
		...
		<?php 
			// If the comments are paginated, display controls
